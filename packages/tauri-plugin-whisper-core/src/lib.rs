//! `tauri-plugin-whisper-core` — Offline, real-time Speech-to-Text for Tauri v2.
//!
...
//! acceleration (CUDA / Metal / CoreML), Silero VAD, and Pyannote Speaker Diarization.
//!
//! # Quick Start
//!
//! ```rust,ignore
...
/// Initialises the whisper-core plugin.
///
